...
class OrderFormHandler
{
    ...
    private FilterBuilderUpdater $builderUpdater;

    public function __construct(OrderManager $orderManager, PaginatorInterface $paginator, FilterBuilderUpdater $builderUpdater)
    {
    ...
    public function processOrderFiltersForm (Request $request ,FormInterface $filterForm)
    {
        ...
        if($filterForm->isSubmitted()){
            $this->builderUpdater->addFilterConditions($filterForm , $queryBuilder);
        }
